    ...
    <main class="bg-gray-50 h-screen flex flex-col overflow-hidden">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-10">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 mt-1">Fill in the form below to create content</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Form Card -->
                <div class="max-w-4xl">
                    <form action="{{ route('content.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-8 py-6">
                                ...
                                <p class="text-blue-100 text-sm mt-1">Enter the details for your new content</p>
                            </div>
                            ...
                            <div class="p-8 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="6"
                                        ...
                                        placeholder="Enter content description" required>{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                ...
                                <!-- Selected User Preview (Optional Enhancement) -->
                                <div id="user-preview"
                                    class="hidden bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center text-white font-semibold">
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700">Make sure to fill in all required fields marked with
                                    <span class="text-red-500">*</span>. The content will be assigned to the selected
                                    user.
                                </p>
                            </div>
                        </div>
