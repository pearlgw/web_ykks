                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-8">
                            <div class="flex items-center gap-4">
                                @if ($program->icon_image)
                                    <div
                                        class="w-16 h-16 bg-white rounded-xl flex items-center justify-center shadow-lg overflow-hidden">
                            ...
                            @if ($program->icon_image)
                                <div class="pb-6 border-b-2 border-blue-100">
                                    <div class="flex items-center gap-2 mb-3">
                                        ...
                                        <p class="text-xs font-bold text-blue-600 uppercase tracking-wider">Program Icon
                                        </p>
                                    </div>
                                    <div class="flex items-center gap-4">
                                        <img src="{{ asset('storage/' . $program->icon_image) }}"
                                            alt="{{ $program->title }}"
                                            class="w-32 h-32 object-cover rounded-xl border-4 border-blue-100 shadow-md">
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-700 mb-1">Program Icon Image</p>
                                            <p class="text-xs text-gray-500">This icon represents the program visually
                                            </p>
                                        </div>
                                    </div>
                                </div>
