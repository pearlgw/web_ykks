<x-app-layout>
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-10">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Literacy Corner</h1>
                        <p class="text-gray-500 mt-1">Manage all Literacy Corner</p>
                    </div>
                </div>
                ...
                <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <a href="{{ route('literacy-corner.create') }}"
                        ...
                        <tr class="hover:bg-indigo-50 transition duration-150 group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('literacy-corner.show', $item->id) }}"
            ...
            @empty
                <div class="text-center py-16 px-4">
                    ...
                    <h3 class="text-xl font-semibold text-gray-600 mb-2">No Literacy Corner Found</h3>
                    <p class="text-gray-500">
                        @if (request('search'))
                            No results found for "{{ request('search') }}"
                        @else
                            No Literacy Corner yet
                        @endif
                    </p>
                </div>
                @endforelse
                    ...
                    <ul class="flex items-center gap-1">
                        ...
                        @foreach ($items->getUrlRange(1, $items->lastPage()) as $page => $url)
                            ...
                            @elseif (
                                $page == 1 ||
                                    $page == $items->lastPage() ||
                                    ($page >= $items->currentPage() - 1 && $page <= $items->currentPage() + 1))
                                <li>
                                    <a href="{{ $url }}"
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all animate-scale-in">
            ...
            <div class="bg-gradient-to-r from-red-500 to-rose-600 px-6 py-5 rounded-t-2xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white">Delete Literacy Corner</h3>
            ...
            <div class="p-6">
                <div class="mb-6">
                    <p class="text-gray-700 mb-4">Are you sure you want to delete this literacy corner?</p>
                    <div class="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-lg p-4">
                        <p class="text-xs font-semibold text-red-900 mb-2 uppercase tracking-wide">Literacy Corner
                            Title</p>
                        <p class="text-sm font-medium text-red-700" id="deleteLiteracyTitle"></p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700 leading-relaxed">This will permanently delete the
                                literacy corner
    ...
    <script>
        ...
        // Modal Functions
        function openDeleteModal(literacy_cornerId, literacy_cornerTitle) {
            const modal = document.getElementById('deleteModal');
            const form = document.getElementById('deleteForm');
            const nameElement = document.getElementById('deleteLiteracyTitle');

            form.action = `/literacy-corner/${literacy_cornerId}`;
            nameElement.textContent = literacy_cornerTitle;
            ...
            if (searchInput) {
                searchInput.addEventListener("input", function() {
                    ...
                    timer = setTimeout(() => {
                        ...
                        fetch(`/literacy-corner?search=${encodeURIComponent(query)}`, {
                                headers: {
                            ...
                            .catch(err => console.error("Error fetching literacy-corner:", err));
                    }, 400);
                });
            }
        });
