            ...
            <main class="flex-1 overflow-y-auto p-10">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-gray-800">Create New News</h1>
                            <p class="text-gray-500 mt-1">Fill in the form below to create a new news</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                                ...
                                <p class="text-blue-100 text-sm mt-1">Enter the details for the new news</p>
                            </div>
                            ...
                            <div class="p-8 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4"
                                        ...
                                        placeholder="Enter news description" required>{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="from_news" name="from_news" value="{{ old('from_news') }}"
                        ...
                        <div class="flex gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700">Fill in all required fields marked with <span
                                    ...
                                    description, news source, and the date & time of the news.</p>
                            </div>
                        </div>
                    </div>
                </div>
