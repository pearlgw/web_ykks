        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-10">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1">Manage all staff</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    @forelse($staffs as $index => $staff)
                        ...
                        <tr class="hover:bg-indigo-50 transition duration-150 group">
                            ...
                            <!-- Message -->
                            <td class="px-6 py-4">
                                <span class="text-sm text-gray-600">{{ $staff->role }}</span>
                            </td>

                            <!-- Created At -->
                            <td class="px-6 py-4">
                                <div class="text-sm">
                                    <p class="font-medium text-gray-900">{{ $staff->created_at->format('d M Y') }}</p>
                                    <p class="text-gray-500 text-xs">{{ $staff->created_at->format('H:i') }}</p>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        onclick="openDeleteModal({{ $staff->id }}, '{{ addslashes($staff->name) }}')"
            ...
            @empty
                <div class="text-center py-16 px-4">
                    ...
                    <h3 class="text-xl font-semibold text-gray-600 mb-2">No Staffs Found</h3>
                ...
                <nav class="bg-white rounded-lg shadow-sm px-4 py-3 border border-gray-100 inline-flex items-center">
                    <ul class="flex items-center gap-1">
                        ...
                        @foreach ($staffs->getUrlRange(1, $staffs->lastPage()) as $page => $url)
                            ...
                            @elseif (
                                $page == 1 ||
                                    $page == $staffs->lastPage() ||
                                    ($page >= $staffs->currentPage() - 1 && $page <= $staffs->currentPage() + 1))
                                <li>
                                    <a href="{{ $url }}"
                                        class="px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition duration-200 font-medium">{{ $page }}</a>
                                </li>
                            @elseif ($page == $staffs->currentPage() - 2 || $page == $staffs->currentPage() + 2)
                                <li>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all animate-scale-in">
            ...
            <div class="bg-gradient-to-r from-red-500 to-rose-600 px-6 py-5 rounded-t-2xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-white">Delete Staff</h3>
            ...
            <div class="p-6">
                <div class="mb-6">
                    <p class="text-gray-700 mb-4">Are you sure you want to delete this staff?</p>
                    <div class="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-lg p-4">
                        <p class="text-xs font-semibold text-red-900 mb-2 uppercase tracking-wide">Staff Name</p>
                        <p class="text-sm font-medium text-red-700" id="deleteStaffName"></p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700 leading-relaxed">This will permanently delete the staff
            ...
            if (searchInput) {
                searchInput.addEventListener("input", function() {
                    ...
                    timer = setTimeout(() => {
                        ...
                        fetch(`/staff?search=${encodeURIComponent(query)}`, {
                                headers: {
